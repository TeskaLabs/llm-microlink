...
- `_id` attribute will be generated by the system, don't parse it
...
Each sample log is prefixed by its unique identification.
Analyze each sample log, identify common fields in them and map all fields into the schema.

Inform user briefly about the outcome of the log analysis.
